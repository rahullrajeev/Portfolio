        ...
        <div className="bg-white dark:bg-zinc-950/50 rounded-3xl overflow-hidden border border-zinc-200 dark:border-zinc-800 shadow-sm">
          <div className="bg-zinc-950 p-8 md:p-12 text-white text-center flex flex-col items-center">
            <motion.div 
              ...
              className="w-20 h-20 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl rotate-3 mb-6 shadow-2xl flex items-center justify-center font-bold text-2xl"
            >
              M
            </motion.div>
            ...
            <p className="text-lg md:text-xl font-light opacity-80 max-w-2xl font-sans">
          ...
          <Grid className="gap-y-px gap-x-px bg-zinc-200 dark:bg-zinc-800">
             <div className="col-span-4 md:col-span-8 lg:col-span-6 bg-white dark:bg-zinc-950 p-8 md:p-12 transition-all duration-300 ease-out z-0 hover:z-20 hover:-translate-y-2 hover:-translate-x-2 hover:shadow-[8px_8px_0px_#18181b] dark:hover:shadow-[8px_8px_0px_#fafafa] border-2 border-transparent hover:border-zinc-900 dark:hover:border-zinc-50 outline outline-1 outline-transparent hover:outline-zinc-200 dark:hover:outline-zinc-800 text-zinc-900 dark:text-zinc-50 relative group cursor-default">
                <h3 className="font-display text-xs font-bold tracking-widest text-zinc-700 dark:text-zinc-400 mb-8">System Architecture</h3>
                <div className="space-y-6 font-light text-zinc-800 dark:text-zinc-300 leading-relaxed">
                  <p>
                ...
                <div className="flex flex-wrap gap-2 mt-8">
                  {['React', 'Tailwind CSS', 'Google Gemini API', 'Monaco Editor', 'Vercel', 'TypeScript'].map(tech => (
                    <span key={tech} className="px-3 py-1.5 bg-zinc-100 dark:bg-zinc-900 text-zinc-800 dark:text-zinc-300 text-xs font-semibold rounded-md border border-zinc-200 dark:border-zinc-800">
                      {tech}
                    </span>
                  ))}
                </div>
             ...
             <div className="col-span-4 md:col-span-8 lg:col-span-6 bg-zinc-50 dark:bg-zinc-900 p-8 md:p-12 flex flex-col justify-center items-start transition-all duration-300 ease-out z-0 hover:z-20 hover:-translate-y-2 hover:-translate-x-2 hover:shadow-[8px_8px_0px_#18181b] dark:hover:shadow-[8px_8px_0px_#fafafa] border-2 border-transparent hover:border-zinc-900 dark:hover:border-zinc-50 relative">
               <h3 className="font-display text-xs font-bold tracking-widest text-zinc-700 dark:text-zinc-400 mb-8">Access Points</h3>
               ...
               <div className="flex flex-col w-full gap-4">
                 <a 
                   ...
                   className="group flex items-center justify-between p-6 bg-black dark:bg-zinc-50 text-white dark:text-zinc-900 border-2 border-black dark:border-zinc-50 rounded-xl transition-all duration-200 hover:-translate-y-1 hover:-translate-x-1 hover:shadow-[4px_4px_0px_#18181b] dark:hover:shadow-[4px_4px_0px_#fafafa] active:translate-y-0 active:translate-x-0 active:shadow-none"
                 >
                 ...
                 <a 
                   ...
                   target="_blank" 
                   rel="noopener noreferrer"
                   className="group flex items-center justify-between p-6 bg-white dark:bg-zinc-900 border-2 border-zinc-200 dark:border-zinc-800 text-zinc-900 dark:text-zinc-50 rounded-xl transition-all duration-200 hover:border-zinc-500 dark:hover:border-zinc-400 hover:-translate-y-1 hover:-translate-x-1 hover:shadow-[4px_4px_0px_#18181b] dark:hover:shadow-[4px_4px_0px_#fafafa] active:translate-y-0 active:translate-x-0 active:shadow-none"
                 >
