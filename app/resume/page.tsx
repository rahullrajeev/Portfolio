...
export default function Resume() {
  ...
  return (
    <PageTransition>
      ...
      <section className="min-h-screen py-24 px-6 md:px-12 max-w-5xl mx-auto flex flex-col relative">
        ...
        >
           <div className="w-full h-full bg-white dark:bg-zinc-900 rounded-2xl overflow-hidden">
             {activeResume === "SD" ? (
